...
export default function Card({product, id}) {
  const [truncatedDescription, setTruncatedDescription] = useState(product.description);
  const maxLength = 50;
  ...
  return (
    ...
    <div className=" overflow-hidden mx-1 rounded-lg cursor-pointer" onClick={handleClick}>
